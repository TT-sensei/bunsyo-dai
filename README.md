...
- 入口の最初に「自分で式をたてよう。旅の最後にはお宝がまっています。」と旅の目的を表示
- 1〜3年生を学年別に選択
...
- 7問を最後まで終えると、edu-assetsの150種類からコレクションバッジを1つ発見する
- 「答えをお願い」を使わなかった旅は必ず新しいバッジ、使った旅は同じバッジが出ることもある
- 入口のいちばん下にコレクションを置き、アコーディオンで開閉しながら見つけたバッジを保存する
...
collection.js には edu-assets のコレクション10シリーズ、150種類を登録しています。答えサポートを使わない旅では未獲得のバッジから1つを選び、使った旅では150種類すべてからランダムに選びます。
